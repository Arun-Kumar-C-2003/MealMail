          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex justify-center">
              <input
                ...
                className="w-full rounded-lg border-2 border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:border-transparent focus:ring-orange-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
            {meals.slice(0, 48).map((meal) => (
              <div
                ...
                className="bg-white border-2 shadow border-transparent hover:border-2 hover:border-black hover:shadow-2xl rounded-lg overflow-hidden flex flex-col h-full"
              >
                {/* Header */}
                ...
                <img
                  ...
                  onClick={() =>
                    router.push(`/recipedetails?id=${meal.idMeal}`)
                  }
                />
